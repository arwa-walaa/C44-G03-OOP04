namespace Assignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            D3 = ++D1;
            Console.WriteLine($"After ++D1, D1: {D1}");
            Console.WriteLine($"D3 = ++D1: {D3}");

          
            D3 = --D2;
            Console.WriteLine($"After --D2, D2: {D2}");
            Console.WriteLine($"D3 = --D2: {D3}");

           
            D3 = D2 - D1;
            Console.WriteLine($"D3 = D2 - D1: {D3}");
            ...
            if (D1)
            {
                Console.WriteLine("D1 is non-zero (true)");
            }
            else
            {
                Console.WriteLine("D1 is zero (false)");
            }
